...
export default function ReactInspector() {
    ...
    return (
        <div>
            <div className="inspector__section">
                <div className="inspector__section-title">Render Pipeline</div>
            ...
            <div className="inspector__section">
                <div className="inspector__section-title">Active Updates</div>
                <div className="inspector__stack">
            ...
            <div className="inspector__section">
                ...
                <div className="inspector__metric">
                    ...
                    <span className="inspector__metric-value">reactive</span>
                </div>
            </div>
        </div>
    );
